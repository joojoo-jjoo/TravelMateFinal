...
public interface Userinfo_service {
	...
	public boolean modify_user_auth(User_authVO user_auth);
	...
	// 페이징 고려
		...
		//게시물 총 개수 조회 서비스 - 페이징 시 필요(확인 필요)
	...
	//권한설정
		...
		public List<StatisticsVO> select_user_authority(
				Admin_user_pagingDTO user_pagingDTO);
