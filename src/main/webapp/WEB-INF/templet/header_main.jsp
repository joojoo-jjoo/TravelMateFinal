...
<html>
  <head>
    ...
    <style>
    	...
    	#frnd_slider_right, #frnd_slider_left{
    		cursor : default;
    	}
	...
	<script src="${contextPath }/resources/assets/js/jquery.star-rating.js"></script>
...
<div class = "container-scroller">
	<nav class="sidebar sidebar-offcanvas" id="sidebar">
	            ...
	            <div class="collapse" id="auth">
	              <ul class="nav flex-column sub-menu">
	               <li class="nav-item"> <a class="nav-link" href="${contextPath }/admin/admin-allmember"> 전체회원 목록 </a></li>
	                ...
	                <li class="nav-item"> <a class="nav-link" href="${contextPath }/admin/admin-rate-manage"> 동행/평점관리 </a></li>
	                <li class="nav-item"> <a class="nav-link" href="${contextPath }/admin/admin-member-statistics"> 회원 등록 통계 </a></li>
	                <li class="nav-item"> <a class="nav-link" href="${contextPath }/admin/admin-friend-statistics"> 동행 통계(모집 중) </a></li>
	       		    <li class="nav-item"> <a class="nav-link" href="${contextPath }/admin/admin-friend-statistics2"> 동행 통계(모집 완료) </a></li>
	              </ul>
	            </div>
	          </li>
          </sec:authorize>
      ...
      <div class = "container-fluid page-body-wrapper">
        ...
        <div class = "slider" style = "background-color : #e8edef; position : relative; height : 450px; overflow: hidden; transition : 0.7s;">
        	<div class="pt-5" style = "height : 45%; width : 100%; position : absolute; transition : 0.7s;">
				<a href = "${contextPath }/friend/friend-list">
				<div class = "col-10" style = "float : none; margin : auto; position : relative;">
					<div class = "float-left mt-5">
						<p class = "display-2 text-dark font-weight-bold">내 취향과 딱 맞는</p>
						<p class = "display-2 text-dark font-weight-bold">동행을 찾아보세요!</p>
						<p class = "display-4 text-gray">여행친구를 만들어보세요</p>
					
						<button type="button" class="btn btn-outline-info btn-rounded btn-fw mt-5" style = "height : 50px;">동행 찾기</button>
					</div>
					
					<div style = "width : 50%; height : 50%; right : 0px; bottom : 0px; position : absolute;" class = "float-right mt-5">
						<img src = "${contextPath }/resources/assets/images/main_slider/finger.png" style = "width : 100%;"/>
					</div>
				</div>
				</a>
			</div>
			
			<div class="pt-5" style = " width : 100%; height : 45%; position : absolute; transition : 0.7s; margin-left : -2000px;">
				<a href = "${contextPath }/review/review-list">
				<div class = "col-10" style = "float : none; margin : auto; position : relative; ">
					<div class = "float-left mt-5">
						<p class = "display-2 text-dark font-weight-bold">여행 다녀온 감상을</p>
						<p class = "display-2 text-dark font-weight-bold">공유해 보세요!</p>
						<p class = "display-4 text-gray">여행지식을 공유하세요 </p>
					
						<button type="button" class="btn btn-outline-info btn-rounded btn-fw mt-5" style = "height : 50px;">후기 작성하기</button>
					</div>
					
					<div style = "width : 50%; height : 50%; right : 0px; bottom : 0px; position : absolute;" class = "float-right mt-5">
						<img src = "${contextPath }/resources/assets/images/main_slider/airport.png" style = "width : 100%;"/>
					</div>
				</div>
				</a>
			</div>
