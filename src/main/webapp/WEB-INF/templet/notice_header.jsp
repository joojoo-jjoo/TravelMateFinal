...
<div class = "container-scroller">
        ...
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-	" href="${contextPath }/main"><!-- 로고: 메인페이지 URL -->
      ...
      <div class = "container-fluid page-body-wrapper">
        ...
        <div class = "main-panel">
        	<img src = "${pageContext.request.contextPath }/resources/assets/images/notice/notice_page.png" alt = "이미지 없음" class = "rounded" width = "100%" height = "350px"/>
