...
<%@ include file="../../templet/header.jsp" %>
	...
	<div class="form-group">
		...
		<span class="btn_pack type10 "><button type="button" onclick="fnDateSearch('today'), select_date(this)" 
			  name="search" class="btn btn-outline-secondary"> 오늘</button></span>&nbsp;&nbsp;
		<span class="btn_pack type10"><button type="button" onclick="fnDateSearch('yester'), select_date(this)" 
			  name="search" class="btn btn-outline-secondary">어제</button></span>&nbsp;&nbsp;
		<span class="btn_pack type10"><button type="button" onclick="fnDateSearch('week'), select_date(this)" 
			  name="search" class="btn btn-outline-secondary">일주일</button></span>&nbsp;&nbsp;
		<span class="btn_pack type10"><button type="button" onclick="fnDateSearch('1month'), select_date(this)" 
			  name="search" class="btn btn-outline-secondary">1개월</button></span>&nbsp;&nbsp;
		<span class="btn_pack type10"><button type="button" onclick="fnDateSearch('3month'), select_date(this)" 
		  	name="search" class="btn btn-outline-secondary">3개월</button></span>&nbsp;&nbsp;
		<span class="btn_pack type10"><button type="button" onclick="fnDateSearch('6month'), select_date(this)" 
			  name="search" class="btn btn-outline-secondary">6개월</button></span>&nbsp;&nbsp;
		<span class="btn_pack type10"><button type="button" onclick="fnDateSearch('year'), select_date(this)" 
